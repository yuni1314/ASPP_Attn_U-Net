...
curr_dir = os.getcwd()
#print(curr_dir)
train_dir = os.path.join(curr_dir, 'resized_train/'+'orig_train')
resize_dir = os.path.join(curr_dir, 'resized_train/'+'resized_train')
gt_dir = os.path.join(curr_dir, 'resized_train/'+'resized_gt')
orig_dir = os.path.join(curr_dir, 'resized_train/'+'orig_gt')
#print(orig_dir)
...
for idx,img_name in enumerate(img_list): 
    orig_data[idx] = plt.imread(os.path.join(resize_dir, img_name))
...
model = newmodels.attn_reg(sgd, input_size, losses.dice_loss)
#model = newmodels.attn_unet(sgd, input_size, losses.focal_tversky)
